  ...
  const lessons = [
    {
      ...
      duration: '32 min',
      description: 'Explore how positive psychology merges with health science to create a holistic approach to wellbeing beyond the absence of disease.',
      topics: ['Four Approaches', 'Lifestyle Medicine', 'Salutogenesis', 'MIDUS Study'],
      unlocked: true
    },
    {
      id: 2,
      ...
      duration: '30 min',
      description: 'Discover strength-based coaching approaches and learn what defines effective positive psychology coaching practice.',
      topics: ['Strengths Coaching', 'Optimal Functioning', 'Coaching Models', 'Reframing'],
      unlocked: true
    },
    {
      id: 3,
      ...
      duration: '28 min',
      description: 'Learn how positive psychology principles integrate with clinical practice to support mental health recovery and flourishing.',
      topics: ['Strength-Based Therapy', 'Mental Health Recovery', 'Wellbeing Therapy', 'Dual Continuum'],
      unlocked: true
    },
    {
      id: 4,
      ...
      duration: '26 min',
      description: 'Understand how technology can be designed to enhance wellbeing and the emerging field of positive cyberpsychology.',
      topics: ['Cyberpsychology', 'Tech for Wellbeing', 'Digital Interventions', 'App Design'],
      unlocked: true
    },
    {
      id: 5,
      ...
      duration: '32 min',
      description: 'Explore the SEARCH framework and evidence-based approaches to fostering student wellbeing in schools.',
      topics: ['SEARCH Framework', 'School Interventions', 'Teacher Role', 'Flourishing Classroom'],
      unlocked: true
    },
    {
      id: 6,
      ...
      duration: '30 min',
      description: 'Master job crafting, psychological safety, and strengths-based approaches to creating thriving organisations.',
      topics: ['Job Crafting', 'Strengths at Work', 'Psychological Safety', 'Positive Leadership'],
      unlocked: true
    },
    {
      id: 7,
      title: 'Wellbeing Arts',
      duration: '28 min',
      description: 'Celebrate the role of arts and humanities in human flourishing through photography, music, dance, and creative expression.',
      topics: ['Arts & Flourishing', 'Photography', 'Music & Dance', 'Creative Wellbeing'],
      unlocked: true
    }
  ];
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f8faf9' }}>
      ...
      <div style={{ background: 'linear-gradient(135deg, #14532d 0%, #166534 100%)', padding: '60px 40px', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: 0, right: 0, width: '50%', height: '100%', opacity: 0.1, backgroundImage: 'url(https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=800)', backgroundSize: 'cover', backgroundPosition: 'center' }} />
        <div style={{ maxWidth: 1200, margin: '0 auto', position: 'relative', zIndex: 10 }}>
          ...
          <div style={{ display: 'inline-block', background: 'rgba(255,255,255,0.15)', padding: '8px 16px', borderRadius: 20, fontSize: 13, fontWeight: 600, color: '#86efac', marginBottom: 20, letterSpacing: 1, textTransform: 'uppercase' }}>Module 5 of 5 - Final Module</div>
          <h1 style={{ fontSize: 48, fontWeight: 600, color: '#ffffff', marginBottom: 16, fontFamily: 'Georgia, serif' }}>Multidisciplinary Applications</h1>
          <p style={{ fontSize: 20, color: 'rgba(255,255,255,0.85)', marginBottom: 32, maxWidth: 600 }}>Positive Psychology Across Domains</p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: 48 }}>
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              {lessons.map((lesson, index) => {
                ...
                return (
                  <Link key={lesson.id} href={`/modules/5/lessons/${lesson.id}`} style={{ textDecoration: 'none' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
            ...
            <div style={{ background: '#ffffff', borderRadius: 12, padding: 28, border: '1px solid #e5e7eb' }}>
              ...
              <p style={{ fontSize: 15, color: '#64748b', lineHeight: 1.7, marginBottom: 20 }}>Explore how positive psychology has been applied across diverse fields - from healthcare to education, workplace to the arts. See how the science of flourishing transforms every domain it touches.</p>
              <h4 style={{ fontSize: 14, fontWeight: 600, color: '#111827', marginBottom: 12, textTransform: 'uppercase', letterSpacing: 0.5 }}>Application Areas</h4>
              <div style={{ fontSize: 13, color: '#64748b', lineHeight: 1.7 }}>
                <p style={{ marginBottom: 8 }}>Health & Medicine</p>
                <p style={{ marginBottom: 8 }}>Coaching & Therapy</p>
                <p style={{ marginBottom: 8 }}>Technology & Digital</p>
                <p style={{ marginBottom: 8 }}>Education & Schools</p>
                <p style={{ marginBottom: 8 }}>Workplace & Leadership</p>
                <p>Arts & Humanities</p>
              </div>
            </div>

            <Link href="/modules/5/lessons/1" style={{ textDecoration: 'none' }}>
              <button style={{ width: '100%', padding: '16px 24px', background: '#14532d', color: '#ffffff', border: 'none', borderRadius: 10, fontSize: 16, fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10 }}>
                {completedCount === 0 ? 'Start Final Module' : 'Continue Learning'}
